    ...
    >
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          >
            I'm <span className="text-foreground font-medium">Bagus Prayogo</span>. I lead large-scale infrastructure rollouts across Indonesia — 100+ concurrent sites, aggressive timelines, zero compromises on quality.
          </motion.p>
          ...
          >
            ...
            <div className="flex items-center gap-4 px-4">
              <a
                ...
                className="p-3 bg-secondary rounded-full text-muted-foreground hover:text-foreground hover:bg-accent transition-colors"
